...
echo -e "\e[96m"
echo "--------------------------------------------"
echo " Script de auto-instalação 0.18"
echo "--------------------------------------------"
echo " Autor: Tiago Nervis"
echo " Compatível com Debian 13 (Trixie)"
echo "--------------------------------------------"
echo -e "\e[97m"
...
echo -ne "\e[90m"
apt-get install  --yes ntfs-3g dcfldd ntp nmap whois dnsutils telnet openssh-client unrar unzip zip bzip2 p7zip-full xz-utils net-tools man traceroute wget curl traceroute htop host bash-completion
...
echo -ne "\e[90m"
apt-get remove --yes exim4-base sugar-browse-activity hv3 lxappearance-obconf
